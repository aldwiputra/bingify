	...
	<article
		...
		<div class=" flex flex-col justify-between self-stretch">
			<span
				...
				<span class="text-[10px] font-medium leading-snug sm:text-xs"> In theaters </span>
			</span>
			...
			<div
				...
				<span class="flex items-center gap-1">
					...
					<span class="font-semibold leading-none">
						...
						<span class=" ml-0.5 text-[10px] font-extralight md:text-[11px]"
							>({mainMovie.vote_count})</span>
					</span>
				</span>
			</div>
