...
<article class="pt-2 pl-2">
	<a
		...
		<span
			...
			<svg class="w-1.5 md:w-2" viewBox="0 0 39 38" fill="none" xmlns="http://www.w3.org/2000/svg">
				<path
			...
			<span class="text-[10px] font-normal leading-none tracking-wide text-gray-200 md:text-[11px]">
				{data.vote_average}
			</span>
		</span>
	</a>
	...
	<a href="#" class="group" title={data.title}>
		<h4
			class="mt-3 text-sm font-semibold tracking-wide text-gray-200 line-clamp-1 group-hover:text-sky-500 md:mt-4 lg:text-base">
			{data.title}
		</h4>
	</a>
	<div
