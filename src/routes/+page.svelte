...
<main class="mx-auto max-w-screen-2xl p-0 md:mt-4">
	<div class="grid grid-cols-1 grid-rows-1 overflow-hidden md:rounded-lg">
		<img
			...
			alt="" />
		<article
			class="z-10 col-span-full row-span-full my-10 flex h-fit w-fit items-stretch gap-4 place-self-center">
			<img
			...
			<div class="flex flex-col justify-between self-stretch">
				...
				<p class="max-w-[20ch] text-sm leading-normal text-zinc-400 line-clamp-5">
